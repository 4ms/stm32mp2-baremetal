                                              ...
                                              ETH_L3FilterConfigTypeDef *pL3FilterConfig)
{
  ...
  if(pL3FilterConfig->Protocol != ETH_L3_IPV4_MATCH)
  {
    ...
    *((__IO uint32_t *)(&(heth->Instance->MACL3A00R) + Filter)) = pL3FilterConfig->Ip6Addr[0];
    /* Set Bits[63:32] of 128-bit IP addr */
    *((__IO uint32_t *)(&(heth->Instance->MACL3A10R) + Filter)) = pL3FilterConfig->Ip6Addr[1];
    /* update Bits[95:64] of 128-bit IP addr */
    *((__IO uint32_t *)(&(heth->Instance->MACL3A20) + Filter)) = pL3FilterConfig->Ip6Addr[2];
    /* update Bits[127:96] of 128-bit IP addr */
    *((__IO uint32_t *)(&(heth->Instance->MACL3A30) + Filter)) = pL3FilterConfig->Ip6Addr[3];
  }
  else /* IPv4 protocol is selected */
  {
    /* Set the IPv4 source address match */
    *((__IO uint32_t *)(&(heth->Instance->MACL3A00R) + Filter)) = pL3FilterConfig->Ip4SrcAddr;
                                              ...
                                              ETH_L3FilterConfigTypeDef *pL3FilterConfig)
{
  ...
  if(pL3FilterConfig->Protocol != ETH_L3_IPV4_MATCH)
  {
    ...
    pL3FilterConfig->Ip6Addr[2] = *((__IO uint32_t *)(&(heth->Instance->MACL3A20) + Filter));
    pL3FilterConfig->Ip6Addr[3] = *((__IO uint32_t *)(&(heth->Instance->MACL3A30) + Filter));
  }
  else
  {
