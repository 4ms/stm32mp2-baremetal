...
typedef struct
{
  ...
  uint32_t CbFirst;                    /*!< Cb compoent first */
...
typedef struct
{
  ...
  uint32_t FrameBufferPich;            /*!< Frame buffer pich in bytes */
...
/** @defgroup LTDC_Private_Macros LTDC Private Macros
  * @{
  */
#define LTDC_LAYER(__HANDLE__, __LAYER__)              ((LTDC_Layer_TypeDef *)((uint32_t)(((uint32_t)((__HANDLE__)->Instance)) + 0x100U + (0x100U*(__LAYER__)))))
