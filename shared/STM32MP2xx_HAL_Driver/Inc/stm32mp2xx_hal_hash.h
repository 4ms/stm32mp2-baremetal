...
#define HASH_ALGOSELECTION_SHA1            ((0x0*HASH_CR_ALGO_1) + (0x0*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA224          ((0x1*HASH_CR_ALGO_1) + (0x0*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA256          ((0x1*HASH_CR_ALGO_1) + (0x1*HASH_CR_ALGO_0))

#define HASH_ALGOSELECTION_SHA384          ((0x1*HASH_CR_ALGO_3) + (0x1*HASH_CR_ALGO_2) + (0x0*HASH_CR_ALGO_1) + (0x0*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA512_224      ((0x1*HASH_CR_ALGO_3) + (0x1*HASH_CR_ALGO_2) + (0x0*HASH_CR_ALGO_1) + (0x1*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA512_256      ((0x1*HASH_CR_ALGO_3) + (0x1*HASH_CR_ALGO_2) + (0x1*HASH_CR_ALGO_1) + (0x0*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA512          ((0x1*HASH_CR_ALGO_3) + (0x1*HASH_CR_ALGO_2) + (0x1*HASH_CR_ALGO_1) + (0x1*HASH_CR_ALGO_0))

#define HASH_ALGOSELECTION_SHA3_224        ((0x0*HASH_CR_ALGO_3) + (0x1*HASH_CR_ALGO_2) + (0x0*HASH_CR_ALGO_1) + (0x0*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA3_256        ((0x0*HASH_CR_ALGO_3) + (0x1*HASH_CR_ALGO_2) + (0x0*HASH_CR_ALGO_1) + (0x1*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA3_384        ((0x0*HASH_CR_ALGO_3) + (0x1*HASH_CR_ALGO_2) + (0x1*HASH_CR_ALGO_1) + (0x0*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHA3_512        ((0x0*HASH_CR_ALGO_3) + (0x1*HASH_CR_ALGO_2) + (0x1*HASH_CR_ALGO_1) + (0x1*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHAKE_128       ((0x1*HASH_CR_ALGO_3) + (0x0*HASH_CR_ALGO_2) + (0x0*HASH_CR_ALGO_1) + (0x0*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_SHAKE_256       ((0x1*HASH_CR_ALGO_3) + (0x0*HASH_CR_ALGO_2) + (0x0*HASH_CR_ALGO_1) + (0x1*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_RAWSHAKE_128    ((0x1*HASH_CR_ALGO_3) + (0x0*HASH_CR_ALGO_2) + (0x1*HASH_CR_ALGO_1) + (0x0*HASH_CR_ALGO_0))
#define HASH_ALGOSELECTION_RAWSHAKE_256    ((0x1*HASH_CR_ALGO_3) + (0x0*HASH_CR_ALGO_2) + (0x1*HASH_CR_ALGO_1) + (0x1*HASH_CR_ALGO_0))
...
#define HASH_FULLSWAPCONTEXT_BUFFER_WSIZE             (4U + HASH_NUMBER_OF_CSR_REGISTERS)  /*!< Save/Restore HASH_IMR + HASH_STR + HASH_CR + HASH_SHA3CFGR + HASH_CSRx */
...
#define HASH_DIGEST_LENGTH() ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHA1)         ?  20U : \
                             ...
                             ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_SHAKE_256)    ?  32U : \
                             ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_RAWSHAKE_128) ?  16U : \
                             ((READ_BIT(HASH->CR, HASH_CR_ALGO) == HASH_ALGOSELECTION_RAWSHAKE_256) ?  32U : \
...
/**
  ...
  * @retval SET (__SIZE__ is valid) or RESET (__SIZE__ is invalid)
  */
#define IS_HASH_DMA_MULTIBUFFER_SIZE(__SIZE__)  ((READ_BIT(HASH->CR, HASH_CR_MDMAT) == 0U) || (((__SIZE__) % 16U) == 0U))
...
/**
  ...
  * @retval SET (__SIZE__ is valid) or RESET (__SIZE__ is invalid)
  */
#define IS_HMAC_DMA_MULTIBUFFER_SIZE(__HANDLE__,__SIZE__)  ((((__HANDLE__)->DigestCalculationDisable) == RESET) || (((__SIZE__) % 16U) == 0U))
/**
...
#include "stm32mp2xx_hal_hash_ex.h"
/* Exported functions --------------------------------------------------------*/
...
void HASH_DriverTest_CheckAskSuspend_Poll(HASH_HandleTypeDef *hhash, uint32_t buffercounter);
void HASH_DriverTest_CheckAskSuspend_IT(HASH_HandleTypeDef *hhash);
