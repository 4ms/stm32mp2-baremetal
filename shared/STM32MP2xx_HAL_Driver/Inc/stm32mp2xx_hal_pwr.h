...
(PWR_WAKEUP_PIN_ID6 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_HIGH << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
#define PWR_WAKEUP_PIN5_HIGH                 \
(PWR_WAKEUP_PIN_ID5 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_HIGH << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
#define PWR_WAKEUP_PIN4_HIGH                 \
(PWR_WAKEUP_PIN_ID4 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_HIGH << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
#define PWR_WAKEUP_PIN3_HIGH                 \
(PWR_WAKEUP_PIN_ID3 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_HIGH << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
#define PWR_WAKEUP_PIN2_HIGH                 \
(PWR_WAKEUP_PIN_ID2 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_HIGH << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
#define PWR_WAKEUP_PIN1_HIGH                 \
(PWR_WAKEUP_PIN_ID1 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_HIGH << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)

#define PWR_WAKEUP_PIN6_LOW                 \
(PWR_WAKEUP_PIN_ID6 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_LOW << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
#define PWR_WAKEUP_PIN5_LOW                 \
(PWR_WAKEUP_PIN_ID5 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_LOW << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
#define PWR_WAKEUP_PIN4_LOW                 \
(PWR_WAKEUP_PIN_ID4 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_LOW << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
#define PWR_WAKEUP_PIN3_LOW                 \
(PWR_WAKEUP_PIN_ID3 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_LOW << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
#define PWR_WAKEUP_PIN2_LOW                 \
(PWR_WAKEUP_PIN_ID2 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_LOW << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
#define PWR_WAKEUP_PIN1_LOW                 \
(PWR_WAKEUP_PIN_ID1 << PWR_WAKEUP_PIN_ID_Pos) | (PWR_WAKEUP_LOW << PWR_WAKEUP_EDGE_Pos) | (PWR_WAKEUP_NOPULL << PWR_WAKEUP_PULL_Pos)
...
#define IS_AN_INTERRUPT_PWR_EXTI_MODE(MODE) (((MODE) == PWR_EXTI_MODE_IT_RISING)         || ((MODE) == PWR_EXTI_MODE_IT_FALLING) || \
...
/** @defgroup PWR_Access_filtering PWR Access filtering (non sharable then wio resource)
  * @{
  */
#define NS_RESOURCE_Pos                               0U

#define NON_SHAREABLE_RESSOURCE_0                     (1U << (0 + NS_RESOURCE_Pos))   /*!< non shareable Resource1 access control  */
#define NON_SHAREABLE_RESSOURCE_1                     (1U << (1 + NS_RESOURCE_Pos))   /*!< non shareable Resource2 access control  */
#define NON_SHAREABLE_RESSOURCE_2                     (1U << (2 + NS_RESOURCE_Pos))   /*!< non shareable Resource3 access control  */
#define NON_SHAREABLE_RESSOURCE_3                     (1U << (3 + NS_RESOURCE_Pos))   /*!< non shareable Resource4 access control  */
#define NON_SHAREABLE_RESSOURCE_4                     (1U << (4 + NS_RESOURCE_Pos))   /*!< non shareable Resource5 access control  */
#define NON_SHAREABLE_RESSOURCE_5                     (1U << (5 + NS_RESOURCE_Pos))   /*!< non shareable Resource5 access control  */
#define NON_SHAREABLE_RESSOURCE_6                     (1U << (6 + NS_RESOURCE_Pos))   /*!< non shareable Resource5 access control  */
...
#define WIO_RESOURCE_0                     (1U << (0 + WIO_RESOURCE_Pos))   /*!< shareable wake-up IO  Resource1 access control  */
#define WIO_RESOURCE_1                     (1U << (1 + WIO_RESOURCE_Pos))   /*!< shareable wake-up IO  Resource2 access control  */
#define WIO_RESOURCE_2                     (1U << (2 + WIO_RESOURCE_Pos))   /*!< shareable wake-up IO  Resource3 access control  */
#define WIO_RESOURCE_3                     (1U << (3 + WIO_RESOURCE_Pos))   /*!< shareable wake-up IO  Resource4 access control  */
#define WIO_RESOURCE_4                     (1U << (4 + WIO_RESOURCE_Pos))   /*!< shareable wake-up IO  Resource5 access control  */
#define WIO_RESOURCE_5                     (1U << (5 + WIO_RESOURCE_Pos))   /*!< shareable wake-up IO  Resource5 access control  */


#define WIO_PIN_ATTR_PRIV_SELECT          0x01000000U
#define WIO_PIN_ATTR_SEC_SELECT           0x02000000U
#define WIO_PIN_ATTR_CID_SHARED_MASK      (PWR_WIO1CIDCFGR_SEMWLC0 | PWR_WIO1CIDCFGR_SEMWLC1 | PWR_WIO1CIDCFGR_SEMWLC2 | \
...
/** @defgroup PWR_D1_state PWR D1 state
  * @{,
  */
#define PWR_D1_DRUN                    0U   /* CPU1 is in CRUN or CSLEEP */
#define PWR_D1_DSTOP1                  1U   /* CPU1 is in CSTOP (D1 clock stalled) with no additionnal power saving request set */
#define PWR_D1_DSTOP2                  2U   /* CPU1 is in CSTOP (D1 clock stalled) with LPwr power saving request set */
#define PWR_D1_DSTOP3                  3U   /* CPU1 is in CSTOP (D1 clock stalled) with LPwr/LVoltage power saving request set*/
#define PWR_D1_DSTANDBY                4U   /* D1 is not powered */
/** @defgroup PWR_D2_state PWR D2 state
  * @{
  */
#define PWR_D2_RUN                     0U   /* CPU2 is CRUN or CSLEEP */
#define PWR_D2_STOP                    1U   /* CPU1/CPU2 are in CSTOP (D1/D2 clock stalled) with no additionnal power saving request set*/
#define PWR_D2_LP_STOP                 2U   /* CPU1/CPU2 are in CSTOP (D1/D2 clock stalled) with no LPwr power saving request set*/
#define PWR_D2_LPLVSTOP2               3U   /* D1 not powered, CPU2 is in CSTOP (D2 clock stalled) with LPwr/LVotage power saving request set*/
#define PWR_D2_STANDBY                 4U   /* D2/D1 not powered (D3 may be powered or not according to CPU3 activity)*/
#define PWR_D2_VBAT                    5U   /* system is on VBAT */
...
#define PWR_FLAG_VDDGPURDY               (0x00U)   /* to check readyness of GPU power domain       */
#else /* ! defined(STM32MP2XX_ASSY2_3_2) */
#define PWR_FLAG_GPUPDRDY               (0x00U)   /* to check readyness of GPU power domain       */
#endif /* else ! defined(STM32MP2XX_ASSY2_3_2) */
#define PWR_FLAG_GPUPDRDY               (0x00U)   /* to check readyness of GPU power domain       */
#define PWR_FLAG_D3RDY                  (0x01U)   /* to check readyness of D3 domain supply       */
...
#define PWR_FLAG_USB                    (0x08U)   /* to check readyness of  USB supply */
...
#define IS_NS_RESOURCE_ATTRIBUTES(__ATTRIBUTES__)   (\
                       (((__ATTRIBUTES__) & NS_RESOURCE_ATTR_CID_STATIC_SELECT ) == NS_RESOURCE_ATTR_CID_STATIC_SELECT)    ||\
                       (((__ATTRIBUTES__) & NS_RESOURCE_CID_DISABLE            ) == NS_RESOURCE_CID_DISABLE)               ||\
                       (((__ATTRIBUTES__) & NS_RESOURCE_ATTR_SEC_SELECT )        == NS_RESOURCE_ATTR_SEC_SELECT)           ||\
                       (((__ATTRIBUTES__) & NS_RESOURCE_ATTR_PRIV_SELECT)        == NS_RESOURCE_ATTR_PRIV_SELECT)            )
#else
#define IS_NS_RESOURCE_ATTRIBUTES(__ATTRIBUTES__)   (\
                       (((__ATTRIBUTES__) & NS_RESOURCE_ATTR_CID_STATIC_SELECT ) == NS_RESOURCE_ATTR_CID_STATIC_SELECT)    ||\
                       (((__ATTRIBUTES__) & NS_RESOURCE_CID_DISABLE            ) == NS_RESOURCE_CID_DISABLE)               ||\
...
#if defined (CORTEX_IN_SECURE_STATE)
#define IS_WIO_PIN_ATTRIBUTES(__ATTRIBUTES__)   ((((__ATTRIBUTES__) & WIO_PIN_ATTR_CID_SHARED_SELECT ) == WIO_PIN_ATTR_CID_SHARED_SELECT)    ||\
                                                 (((__ATTRIBUTES__) & WIO_PIN_ATTR_CID_STATIC_SELECT ) == WIO_PIN_ATTR_CID_STATIC_SELECT)    ||\
                                                 (((__ATTRIBUTES__) & WIO_PIN_CID_DISABLE            ) == WIO_PIN_CID_DISABLE)               ||\
                                                 (((__ATTRIBUTES__) & WIO_PIN_ATTR_SEC_SELECT )        == WIO_PIN_ATTR_SEC_SELECT)           ||\
                                                 (((__ATTRIBUTES__) & WIO_PIN_ATTR_PRIV_SELECT)        == WIO_PIN_ATTR_PRIV_SELECT)            )
#else
#define IS_WIO_PIN_ATTRIBUTES(__ATTRIBUTES__)   ((((__ATTRIBUTES__) & WIO_PIN_ATTR_CID_SHARED_SELECT ) == WIO_PIN_ATTR_CID_SHARED_SELECT)    ||\
                                                 (((__ATTRIBUTES__) & WIO_PIN_ATTR_CID_STATIC_SELECT ) == WIO_PIN_ATTR_CID_STATIC_SELECT)    ||\
                                                 (((__ATTRIBUTES__) & WIO_PIN_CID_DISABLE            ) == WIO_PIN_CID_DISABLE)               ||\
...
((__FLAG__) == PWR_FLAG_VDDGPURDY)?((PWR->CR12 & PWR_CR12_VDDGPURDY)           == PWR_CR12_VDDGPURDY) :    \
((__FLAG__) == PWR_FLAG_PVDO)    ?((PWR->CR3  & PWR_CR3_PVDO)                == PWR_CR3_PVDO)      :    \
...
((__FLAG__) == PWR_FLAG_VDDcoreL)?((PWR->CR5  & PWR_CR5_VCOREL)              == PWR_CR5_VCOREL)    :    \
((__FLAG__) == PWR_FLAG_VDDcoreH)?((PWR->CR5  & PWR_CR5_VCOREH)              == PWR_CR5_VCOREH)    :    \
((__FLAG__) == PWR_FLAG_VDDcpuL) ?((PWR->CR6  & PWR_CR6_VCPUL)               == PWR_CR6_VCPUL)     :    \
((__FLAG__) == PWR_FLAG_VDDcpuH) ?((PWR->CR6  & PWR_CR6_VCPUH)               == PWR_CR6_VCPUH)     :    \
...
((__FLAG__) == PWR_FLAG_VB)        ?((PWR->CPU1CR & PWR_CPU1CR_VBF)           == PWR_CPU1CR_VBF)    :        \
((__FLAG__) == PWR_FLAG_SB_D3)     ?((PWR->CPU1CR & PWR_CPU1CR_SBF_D3)        == PWR_CPU1CR_SBF_D3) :        \
((__FLAG__) == PWR_FLAG_SB_D1)     ?((PWR->CPU1CR & PWR_CPU1CR_SBF_D1)        == PWR_CPU1CR_SBF_D1) :        \
((__FLAG__) == PWR_FLAG_SB)        ?((PWR->CPU1CR & PWR_CPU1CR_SBF)           == PWR_CPU1CR_SBF)    :        \
((__FLAG__) == PWR_FLAG_STOP)      ?((PWR->CPU1CR & PWR_CPU1CR_STOPF)         == PWR_CPU1CR_STOPF)  :        \
(__HAL_PWR_GET_COMMON_FLAG(__FLAG__)))
#elif defined (CORE_CM33)
#define __HAL_PWR_GET_FLAG(__FLAG__) ( \
((__FLAG__) == PWR_FLAG_VB)        ?((PWR->CPU2CR & PWR_CPU2CR_VBF)           == PWR_CPU2CR_VBF)    :        \
((__FLAG__) == PWR_FLAG_SB_D3)     ?((PWR->CPU2CR & PWR_CPU2CR_SBF_D3)        == PWR_CPU2CR_SBF_D3) :        \
((__FLAG__) == PWR_FLAG_SB_D2)     ?((PWR->CPU2CR & PWR_CPU2CR_SBF_D2)        == PWR_CPU2CR_SBF_D2) :        \
((__FLAG__) == PWR_FLAG_SB)        ?((PWR->CPU2CR & PWR_CPU2CR_SBF)           == PWR_CPU2CR_SBF)    :        \
((__FLAG__) == PWR_FLAG_STOP)      ?((PWR->CPU2CR & PWR_CPU2CR_STOPF)         == PWR_CPU2CR_STOPF)  :        \
(__HAL_PWR_GET_COMMON_FLAG(__FLAG__)))
#elif defined (CORE_CM0PLUS)
#define __HAL_PWR_GET_FLAG(__FLAG__) ( \
((__FLAG__) == PWR_FLAG_VB)        ?((PWR->CPU3CR & PWR_CPU3CR_VBF)           == PWR_CPU3CR_VBF)    :        \
((__FLAG__) == PWR_FLAG_SB_D3)     ?((PWR->CPU3CR & PWR_CPU3CR_SBF_D3)        == PWR_CPU3CR_SBF_D3) :        \
(__HAL_PWR_GET_COMMON_FLAG(__FLAG__)))
#endif
...
#if defined(CORE_CM33)||defined(CORE_CA35)
/**
  * @brief EXTI line  '52+k' mask is '1 << exti_line#(52+k)_pos' where k in range  from 0 (PWR wakeup line #0)  to 5 (PWR wakeup line #5)
  * @note    for wake-up line 0 mask is '1<<20'  as EXTI line for wake-up line 0 is line 52 which position is 20 in EXTI_IMR2
  * @note    for wake-up line 5 mask is '1<<25'  as EXTI line for wake-up line 5 is line 57 which position is 25 in EXTI_IMR2
**/
...
/**
  ...
  * @param  __EXTI_LINE_MSK__: specifies mask of the EXTI line which associated interruption shall be enable
...
/**
  ...
  * @param  __EXTI_LINE_MSK__: specifies mask of the EXTI line which associated interruption shall be disable
  *         For M33 or A35 core, this parameter can be one of the following values
  *            @arg __HAL_WKUP_LINE0_EXTI_MSK
  *            @arg __HAL_WKUP_LINE1_EXTI_MSK
  *            @arg __HAL_WKUP_LINE2_EXTI_MSK
