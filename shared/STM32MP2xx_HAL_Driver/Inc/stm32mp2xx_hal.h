...
#define SYSCFG_ETH_RGMII                    (0x1U << SYSCFG_ETH1CR_ETH1_SEL_Pos)  /*!< Select the reduced gigabit media-independent interface*/
#define SYSCFG_ETH_RMII                     (0x4U << SYSCFG_ETH1CR_ETH1_SEL_Pos)  /*!< Select the Reduced Media Independent Interface */
