...
#define IS_NVIC_DEVICE_IRQ(IRQ)                ((IRQ >= 0x00) && (IRQ < MAX_IRQ_n))
...
#define IS_NVIC_PRIORITY_GROUPING(GROUPING) ((GROUPING < 8) && (GROUPING >=0))
...
/* [SYSTICK/MACROS] M0+ (ARMv6-M) / M33 (ARMv8-M) common definitions */
