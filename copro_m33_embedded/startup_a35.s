...
el3_entry:
    ...
    // Open all SRAM blocks (SYSRAM/SRAM1/SRAM2/RETRAM) to every CID and to
    // non-secure accesses, so the A35 can load the M33 image into SRAM2 and the
    // non-secure M33 can then fetch it. See shared/drivers/risab.cc.
